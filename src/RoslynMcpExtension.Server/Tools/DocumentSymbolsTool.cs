...
[McpServerToolType]
public sealed class DocumentSymbolsTool
{
    private readonly RpcClient _rpc;
    public DocumentSymbolsTool(RpcClient rpc) => _rpc = rpc;
    ...
    public async Task<string> GetDocumentSymbols(
        [Description("Absolute path to the C# file")] string filePath)
    {
        var symbols = await _rpc.GetDocumentSymbolsAsync(filePath);
